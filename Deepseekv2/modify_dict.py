        ...
        if "layers" in key:
            ...
            if "self_attention" in key  :
                ...
                if "linear_q_proj" in key:
                    mg_model_state[key] = hf_attn.q_proj.weight   
                if "linear_kv_down_proj" in key:
                    mg_model_state[key] = hf_attn.kv_a_proj_with_mqa.weight   
                if "linear_kv_up_proj" in key:
                    if "linear_kv_up_proj.weight" in key:
                        mg_model_state[key] =  hf_attn.kv_b_proj.weight   
                    elif "linear_kv_up_proj.layer_norm_weight" in key:
                        mg_model_state[key] =  hf_attn.kv_a_layernorm.weight    
                    else:
