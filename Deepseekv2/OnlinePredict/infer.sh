...
export Predictor_Path="/home/download/models/mg_core/DeepSeek-V2-Lite/router"
...
python get_gate_weight.py --root_dir $CHECKPOINT --save_dir $Predictor_Path
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun $DISTRIBUTED_ARGS ../../tools/run_text_generation_server.py   \
       --port 5000 \
       --no-masked-softmax-fusion \
