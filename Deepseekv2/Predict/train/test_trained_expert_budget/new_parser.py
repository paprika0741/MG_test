...
gate_path = "/home/CodeSpace/Megatron-LM-core_v0.12.0/Deepseekv2/Predict/train/trained_gate"
...
# result =  dict()
# for step in range(1,5):
#     data= get_decoding_layer_predict(args,num_layers,topk=topk,step=step)
#     result [step] = data
...
# result =  dict()
# for step in range(1,5):
#     data= get_all_layer_predict(args,num_layers,topk=topk,step=step)
#     result [step] = data
